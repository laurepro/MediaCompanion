...
public class MediaCompanion {
	...
	public void Init( Context ctx, Object parent ) {
		try {
			...
			m_ctx = ctx;
			audioManager = (AudioManager)(m_ctx).getSystemService(Context.AUDIO_SERVICE);
			m_parent = parent;
	...
	private void SendAvrcpMeta(String track, String artist, String album) {
