...
{
	public static String TAG = "HeadsetDetector";	

	//use an alert box instead of toast messages. This helps
	//visually impaired to understand better as it stays on screen, toast messages go away in to short a time to be reviewed.
	//If you don't hear the message, you won't.
	private void alert(String msg) {
		AlertDialog alertDialog = new AlertDialog.Builder(this).create();
		alertDialog.setTitle("Installer");
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
		...
		try {
			ExtractPlugin( this, "HeadsetDetector" );
		}
		catch(Exception e ) {
